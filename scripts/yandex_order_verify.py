...
param_deadline=str(params.get("shipping_end_datetime") or "")
deadline_source=shipping_dt or param_deadline
print("VERIFY_PARAM_SHIPPING_END="+param_deadline)
print("VERIFY_DEADLINE_MATCH="+("1" if expected_date and deadline_source.startswith(expected_date) else "0"))
