...
STATE_FILE = Path(os.getenv("WB_LIGHT_STATE_FILE") or "state/wb_chat_light_state.json")
SUMMARY_FILE = Path(os.getenv("WB_LIGHT_SUMMARY_FILE") or "state/wb_chat_light_summary.json")
LOOKBACK_HOURS = max(1, int(os.getenv("WB_LIGHT_LOOKBACK_HOURS") or "24"))
