...
if not CLIENT_ID or not CLIENT_SECRET:
    raise SystemExit("CDEK_CLIENT_ID/CDEK_CLIENT_SECRET are missing")
...
for name,l,w,h,weight in scenarios:
    packages=[
      {"weight":weight,"length":l,"width":w,"height":h},
      {"weight":weight,"length":l,"width":w,"height":h},
      {"weight":weight,"length":l,"width":w,"height":h},
    ]
    body={
...
with open("cdek-tolyatti-quote-result.json","w",encoding="utf-8") as f:
