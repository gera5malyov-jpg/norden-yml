...
expected_region=str(addr.get("region") or "").strip()
expected_country=str(addr.get("country") or "").strip()
actual_region=str(params.get("shipping_address.region") or "").strip()
actual_country=str(params.get("shipping_address.country") or "").strip()
...
print("VERIFY_BUYER_NAME_TOKEN_MATCH="+("1" if expected_tokens and actual_tokens==expected_tokens else "0"))
...
print("VERIFY_ADDRESS_REGION_MATCH="+("1" if expected_region and actual_region==expected_region else "0"))
print("VERIFY_ADDRESS_COUNTRY_PRESENT="+("1" if expected_country and actual_country else "0"))
